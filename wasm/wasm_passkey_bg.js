...
* @param {any} hash
* @param {any} rp_config
* @param {any} verfication
* @returns {boolean}
*/
export function verify(hash, rp_config, verfication) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.verify(retptr, addHeapObject(hash), addHeapObject(rp_config), addHeapObject(verfication));
